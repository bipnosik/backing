...
from .serializers import (
    ...
    SearchHistorySerializer, FavoriteSerializer, RecentlyViewedSerializer, RecipeAttributeSerializer
)
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        ingredients_list = []
        for i in range(10):  # Предполагаем максимум 10 ингредиентов
    ...
    def update(self, request, pk=None, *args, **kwargs):
        ...
        serializer = self.serializer_class(recipe, data=data, partial=True)
        if serializer.is_valid():
            recipe = serializer.save()
            # Обновляем пошаговые изображения
            if step_images:
